                        ...
                        <div class="properties-widget-area wrap-left">
                            <div class="widget widget_search">
                                <form class="search-form" action="{{ route('properties.leftSidebar') }}" method="GET">
                                    <input type="text" name="search" class="search-field" placeholder="Search property" value="{{ request('search') }}">
                            ...
                            <div class="widget widget_advanced_search">
                                ...
                                <form class="advanced-search-form" action="{{ route('properties.leftSidebar') }}" method="GET">
                                    ...
                                    <div class="form-group">
                                        <input type="number" name="min_area" class="form-control" placeholder="Min Area" value="{{ request('min_area') }}">
                                    </div>
                                    <div class="form-group">
                                        <input type="number" name="max_area" class="form-control" placeholder="Max Area" value="{{ request('max_area') }}">
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-lg-5 col-md-6">
                                    <div class="d-flex align-items-center justify-content-end">
                                        <select class="form-select" onchange="location = this.value;">
                                            <option value="{{ route('properties.leftSidebar', array_merge(request()->query(), ['sort' => 'recommend'])) }}" {{ request('sort') == 'recommend' ? 'selected' : '' }}>Recommend</option>
                                            <option value="{{ route('properties.leftSidebar', array_merge(request()->query(), ['sort' => 'newest'])) }}" {{ request('sort') == 'newest' ? 'selected' : '' }}>Sort by newest</option>
                                            <option value="{{ route('properties.leftSidebar', array_merge(request()->query(), ['sort' => 'latest'])) }}" {{ request('sort') == 'latest' ? 'selected' : '' }}>Sort by latest</option>
                                            <option value="{{ route('properties.leftSidebar', array_merge(request()->query(), ['sort' => 'popularity'])) }}" {{ request('sort') == 'popularity' ? 'selected' : '' }}>Sort by popularity</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-6 col-md-6">
                                <div class="properties-item">
                                    <div class="properties-image">
                                        ...
                                        <ul class="link-list">
                                            <li>
                                                <a href="#" class="link-btn">{{ $property->type->name ?? 'Property' }}</a>
                                            </li>
                                            <li>
                                    ...
                                    <div class="properties-content">
                                        ...
                                        <div class="bottom">
                                            <div class="user">
                                                ...
                                                <a href="#">{{ $property->broker->name ?? 'Broker' }}</a>
                                            </div>
                                            <ul class="group-info">
                                                <li>
                                                    <div class="dropdown">
