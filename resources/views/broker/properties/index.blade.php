            ...
            <div class="tab-pane fade show active" id="table-basic-preview" role="tabpanel"
                ...
                <div class="table-responsive">
                    <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                        ...
                        <a href="{{ route('broker.properties.create', app()->getLocale()) }}" class="btn btn-primary">
                            Create Property
                        </a>
                    </div>

                    <form method="GET" action="{{ route('broker.properties.index', app()->getLocale()) }}" class="row g-2 mb-3">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3 d-flex gap-2">
                            ...
                            <a href="{{ route('broker.properties.index', app()->getLocale()) }}" class="btn btn-outline-secondary">{{ __('admin.general.reset') }}</a>
                        </div>
                    </form>
                        ...
                        <tbody>
                            @foreach ($properties as $property)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('broker.properties.edit', ['locale' => app()->getLocale(), 'id' => $property->id]) }}"
